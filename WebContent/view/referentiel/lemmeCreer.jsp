...
<%
	String includer				=	"lemmeCreer.jsp";
...
<html>
	...
	<body>
		...
		<h1>Cr&eacute;ation d'un lemme</h1>
		
		<div id="main-content" class="full-width">

			<div class="form-container">
			
				<form id="lemme-creation-form" method="post" action="<%= root %>/do/lemmeCreer">
 ...
 TODO							
						...
						<div id="tabs-2">
							...
							<div id="item-orthographic-attributes-left">
								...
								<div class="label-control-container">
									<label id="freqlivres-label" for="freqlivres">Fr&eacute;quence livres</label><input id="freqlivres" name="freqlivres" type="number" step="0.01" value="">
									<div class="clear"></div>
								</div>
								<div class="label-control-container">
									<label id="freqfilms-label" for="freqfilms">Fr&eacute;quence films</label><input id="freqfilms" name="freqfilms" type="number" step="0.01" value="">
									<div class="clear"></div>
								</div>
...
<!-- 						<input id="lemme-creation-submit" type="submit" value="Créer" title="Créer le lemme" disabled> -->
						<input id="lemme-creation-submit" type="submit" value="Créer" title="Créer le lemme">
						<button id="lemme-creation-cancel" type="submit" formaction="<%= root %>/do/annuler" title="Annuler">Annuler</button>
					</div>
